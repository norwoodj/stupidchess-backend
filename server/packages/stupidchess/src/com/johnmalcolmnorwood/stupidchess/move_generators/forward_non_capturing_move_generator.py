...
class ForwardNonCapturingMoveGenerator:
    ...
    def get_possible_moves(self, possible_move_game_state, starting_square=None):
        moves = []
        starting_square = starting_square or possible_move_game_state.get_current_square()
    ...
    @staticmethod
    def add_non_capturing_move(moves, starting_square, square_offset, possible_move_game_state):
        new_square = possible_move_game_state.get_square_for_move_offset(square_offset, starting_square)
