...
class CreateGameForm(FlaskForm):
    ...
    num_players = SelectField("Number of Players", choices=_to_choices(GameAuthType.all()))
    other_player = StringField("Other Player Name", validators=_OTHER_PLAYER_NAME_VALIDATORS, render_kw=_get_render_kw(placeholder="other player name"))
