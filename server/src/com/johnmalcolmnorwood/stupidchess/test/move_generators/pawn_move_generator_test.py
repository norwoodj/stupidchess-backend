...
class PawnMoveGeneratorTest(TestCase):
    ...
    def test_no_captures_no_middle_board_first_move(self):
    ...
    def test_no_captures_no_middle_board_second_move(self):
    ...
    def test_no_captures_no_middle_board_first_move_second_move_blocked(self):
        pieces = [
    ...
    def test_no_captures_no_middle_board_first_move_first_move_blocked(self):
        pieces = [
            Piece(type=PieceType.PAWN, color=Color.BLACK, square=0),
    ...
    def test_one_capture_no_middle_board(self):
        pieces = [
    ...
    def test_two_captures_no_middle_board(self):
        pieces = [
            Piece(type=PieceType.PAWN, color=Color.BLACK, square=1, firstMove=PawnMoveGeneratorTest.FIRST_MOVE),
            Piece(type=PieceType.PAWN, color=Color.WHITE, square=12, firstMove=PawnMoveGeneratorTest.FIRST_MOVE),
            Piece(type=PieceType.PAWN, color=Color.WHITE, square=10, firstMove=PawnMoveGeneratorTest.FIRST_MOVE),
        ]
        ...
        self.assertIn(moves[0].destinationSquare, {10, 11, 12})
        self.assertIn(moves[1].destinationSquare, {10, 11, 12})

        capture_moves = filter(lambda move: move.destinationSquare in {10, 12}, moves)

        for non_cm in filter(lambda move: move.destinationSquare not in {10, 12}, moves):
    ...
    def test_no_captures_middle_board(self):
        pieces = [
    ...
    def test_captures_middle_board(self):
        pieces = [
    ...
    def test_no_en_passant_wasnt_last_move(self):
        en_passant_first_move = FirstMove(startSquare=20, destinationSquare=0, gameMoveIndex=0)
        pieces = [
            Piece(type=PieceType.PAWN, color=Color.BLACK, square=1, firstMove=PawnMoveGeneratorTest.FIRST_MOVE),
            Piece(type=PieceType.PAWN, color=Color.WHITE, square=0, firstMove=en_passant_first_move),
    ...
    def test_no_en_passant_is_not_pawn(self):
        en_passant_first_move = FirstMove(startSquare=20, destinationSquare=0, gameMoveIndex=0)
        pieces = [
            Piece(type=PieceType.PAWN, color=Color.BLACK, square=1, firstMove=PawnMoveGeneratorTest.FIRST_MOVE),
