        ...
        <div id="react-root">
            ...
            <div id="content-wrapper">
                ...
                <Container className="main-container">
                    <Panel>
                        <h3>Welcome to Stupidchess!</h3>
                        <div className="mui-divider"></div>
                        <br/>
                        <p>
                            This is a web-based board game running on a python-flask/mongo backend with a react frontend.
                            It is deployed on my raspberry pi cluster running kubernetes. Visit my github to view the code
                            for how I build and deploy this project. You can see the code itself <a href="https://github.com/norwoodj/stupidchess">here</a>.
                        </p>
                        <p>
            ...
            <div className="footer-height mui--hidden-md mui--hidden-lg mui--hidden-xl"></div>
            <Footer/>
        </div>,
